...
{
    const char* pszTimestamp = "Dulmiga had iyo jeer wuu baabba'ayaa";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1231006505, 2083236893, 0x1d00ffff, 1, 80 * COIN);
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1296688602, 414098458, 0x1d00ffff, 1, 80 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
